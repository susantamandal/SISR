...
flags.DEFINE_integer('size', 128, 'LR image size')
flags.DEFINE_integer('scale', 4, 'scaling factor')
flags.DEFINE_string('dir_train_in', 'Training_inputs/RGB_Target', 'Input folder for training')
flags.DEFINE_string('dir_val_in', 'Validation_inputs/RGB_Test', 'Input folder for Validation')
flags.DEFINE_string('dir_val_target', 'Validation_inputs/RGB_Target', 'Target folder for Validation')
CONFIG=flags.FLAGS
